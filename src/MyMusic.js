...
// import sound from "./assets/music/EasyOnMe.mp3";
    ...
    render(){
        ...
        <div style={styles.myMusicContainer}>
            ...
            <div style={styles.info}>
                <img style={styles.image} src="https://tse3.mm.bing.net/th?id=OIP.s4i8Di-ykO2qrgqjeC28egAAAA&pid=Api&P=0" alt="no internet"></img>
                <div style={styles.subInfo}>
                <h4 style={{marginBottom:'0.5rem'}}>EASY ON ME</h4>
                <p style={{marginBottom:'0'}}>Adele</p>
                </div>
            </div>
